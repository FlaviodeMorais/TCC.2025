      ...
      <div className="flex flex-col flex-1">
        <div className="flex justify-between items-start w-full">
          <div>
            ...
            <p className="text-sm text-gray-300">Projeto de automação de um micro sistema aquapônico utilizando NODEMCU</p>
            <p className="text-xs text-gray-400">DRP04-PJI510-SALA-001GRUPO-012</p>
          </div>
